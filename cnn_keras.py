...
# plotting accuracy for each epoch on training and test data
...
# plotting learning error for each epoch on training and test data
plt.rcParams.update({'font.size': 16})
plt.plot(training_results.history['loss'])
plt.plot(training_results.history['val_loss'])
plt.title('Learning Error vs Epoch')
